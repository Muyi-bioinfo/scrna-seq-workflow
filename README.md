...
| 06 pseudobulk DE | `summary_degs.csv`, `by_celltype/<type>/` (`deseq2_results.tsv` + `significant_degs.tsv`) | `figures/<type>/` (`volcano`, `MAplot`, `PCA`), `summary_05_vs_06`, `all_types_pca` |
